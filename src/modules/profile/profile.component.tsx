...
export const Profile = () => {
  ...
  const [profileData, setProfileData] = useState<typeof formInitialValues | null>(null);
      ...
      {profileData
        ? (
          <div className={styles.wrapper}>
            <Avatar src={profileData.avatar} className={styles.avatar} size={{ xs: 150, sm: 200, md: 200, lg: 200, xl: 200, xxl: 200 }}/>
